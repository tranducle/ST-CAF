...
OUT_FIG = ROOT / "figures" / "ST_CAF_Phase_Exposure.pdf"
OUT_REPORT = ROOT / "phase_analysis_report.json"
...
def run_monotone_stress(n: int, seed: int) -> dict:
    ...
    beta2 = beta1 * rng.uniform(1.0, 3.0, n)
    beta3 = beta2 * rng.uniform(1.0, 3.0, n)
...
def main() -> None:
    ...
    stress = run_monotone_stress(args.n, args.seed)
    report = {
